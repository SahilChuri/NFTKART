...
export default function SellNFT() {
  ...
  async function onFileChange(e) {
    try {
      ...
      if (response.success === true) {
        setBtn(true);
        updateMessage("");
        setFileURL(response.pinataURL); // Set the uploaded image URL
      }
    } catch (e) {
  ...
  async function listNFT(e) {
    try {
      ...
      setFileURL(null); // Reset the file URL after successful upload
        ...
        <div className={styles.innerContainer}>
          <div className={styles.content}>
            ...
            <div className={styles.Form}>
              ...
              {fileURL && ( // Show the uploaded image if the URL is available
                <div className={styles.ImagePreview}>
                  <img src={fileURL} alt="Uploaded NFT" />
                </div>
              )}
